...
class Validation {
	...
	public static $basic_tags     = "<br><p><a><strong><b><i><em><img><blockquote><code><dd><dl><hr><h1><h2><h3><h4><h5><h6><label><ol><ul><li><span><sub><sup>";
	...
	public static function xss_clean(array $data)
	{
		...
		foreach($data as $k => $v)
		{
			$data[$k] = filter_var($v, FILTER_SANITIZE_STRING, $options);
		}
	...
	*/
	 ...
	 * @return string
	 */
	public function filter_urlencode($value, $params = NULL)
	{
	 ...
	 * @return string
	 */
	public function filter_sanitize_numbers($value, $params = NULL)
	{
	 ...
	 * @return string
	 */
	public function filter_basic_tags($value, $params = NULL)
	{
		$data = [];
		if(is_null($params))
		{
			$params = self::$basic_tags;
		}
		...
		if(is_array($value))
		{
			...
			{
				if($params == 'strip_all_tags')
				{
					$data[$val] = strip_tags($val);
				} else {
					$data[$val] = strip_tags($val, $params);
				}
			}
	 ...
	 * @return mixed
	 */
	public function validate_contains($field, $input, $param = NULL)
	{
	 ...
	 * @return mixed
	 */
	public function validate_valid_email($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_max_len($field, $input, $param = NULL)
	{
		if(!isset($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_min_len($field, $input, $param = NULL)
	{
		if(!isset($input[$field]))
		{
			return;
	...
	public function validate_matches($field, $input, $param = NULL)
	{
		if( $field === $input )
		return TRUE;
	...
	*/
	 ...
	 * @return mixed
	 */
	public function validate_exact_len($field, $input, $param = NULL)
	{
		if(!isset($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_alpha($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_alpha_numeric($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_alpha_dash($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_integer($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_boolean($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_float($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_valid_url($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_url_exists($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_valid_ip($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 */
	public function validate_valid_ipv4($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_valid_ipv6($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_valid_cc($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_valid_name($field, $input, $param = NULL)
	{
		if(!isset($input[$field])|| empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_street_address($field, $input, $param = NULL)
	{
		if(!isset($input[$field])|| empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_iban($field, $input, $param = NULL)
	{
		if(!isset($input[$field]) || empty($input[$field]))
		{
			return;
	 ...
	 * @return mixed
	 */
	public function validate_date($field, $input, $param = null)
	{
		if (!isset($input[$field]) || empty($input[$field])) {
			return;
		}
	 ...
	 * @return mixed
	 */
	public function validate_max_numeric($field, $input, $param = null)
	{
		if (!isset($input[$field]) || empty($input[$field])) {
			return;
		}
	 ...
	 * @return mixed
	 */
	public function validate_min_numeric($field, $input, $param = null)
	{
		if (!isset($input[$field]) || empty($input[$field])) {
			return;
		}
