...
{else}
  ...
  <div class="main" data-animation-effect="fadeInDownSmall" data-effect-delay="300">
    <div class="form-block center-block">
      ...
      <hr>
      <form class="form-horizontal range-field w-75" method="post" action="{$smarty.const.SITE_URL}login/login_validate">
      ...
      {if $route eq 'error'}
        ...
        <div class="form-group has-feedback">
          <label for="email" class="col-sm-2 control-label pull-left">Email</label>
          <div class="input-group mb-2 col-sm-8">
          <div class="input-group-prepend">
            <div class="input-group-text"><i class="fa fa-envelope form-control-feedback"></i></div>
          </div>
            <input type="email" class="form-control" name="email" id="email" placeholder="Email" required>
          </div>
        </div>
        <div class="form-group has-feedback">
          <label for="password" class="col-sm-2 control-label pull-left">Password</label>
          <div class="input-group mb-2 col-sm-8">
          <div class="input-group-prepend">
            <div class="input-group-text"><i class="fa fa-lock form-control-feedback"></i></div>
          </div>
