...
<div id="stickybar" class="expstickybar">
	...
	<div class="row">
		...
		<div class="col-md-2">
			<i class="fa fa-clock-o red"></i> Script exec. time: {$exec_time} sec
		</div>
		<div class="col-md-4">
			<i class="fa fa-memory red"></i> [RAM usage] current: {$ram_usage} | Peak: {$ram_peak_usage}
		</div>
		<div class="col-md-3"></div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col">
				<strong>View File(s):</strong> {$smarty.template}
			</div>
			<div class="col">
				<span>2 of 3</span>
			</div>
