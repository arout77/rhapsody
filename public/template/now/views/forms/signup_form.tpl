...
<body class="hold-transition register-page" style="background-image: url({$smarty.const.SITE_URL}media/images/patterns/pattern2.png);">
<div class="register-box" id="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{$smarty.const.SITE_URL}" class="doodoo-brown"><h1>Rhapsody<br> <small>Support Portal</small></h1></a>
    </div>
    <div class="card-body">
      ...
      <form id="signup" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <span>If you already have a company ID, enter it now</span>
        </div>
        <div class="row">
          <div class="col-8">
    ...
    $.ajax({
      ...
      success: function(response) {
        function appends(element) {
          ...
          // to avoid duplicates
          var optionExists = ($('#companies option[value="' + element['name'] + '"]').length > 0);
          if(!optionExists) {
            $('<option/>').val(element['name']).text(element['name']).appendTo('#companies');
          }
        }
